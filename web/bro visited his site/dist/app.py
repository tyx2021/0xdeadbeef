...
app.config["FLAG"] = "deadbeef{REDACTED2}"
...
def bro_visited():
    ...
    return render_template('bro_visited.html', message='deadbeef{REDACTED1}')
...
def vibe_check():
    ...
    """) # why render_template_string all of a sudden?? fix this ltr
